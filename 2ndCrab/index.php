...
<body>
    ...
    <h1>Leader</h1><span><h1>Board</h1></span>
        <p>Please</p>
        <button id="statsBtn">Login/SignUp</button>
        <p> to view</p>
    </div>
    </div>
